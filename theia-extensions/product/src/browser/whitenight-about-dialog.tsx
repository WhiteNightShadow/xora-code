...
@injectable()
export class WhiteNightAboutDialog extends AboutDialog {
    ...
    protected override renderHeader(): React.ReactNode {
        return <>
            ...
            <div className='about-details'>
                ...
                <p>WhiteNight Code is an independent community project and is not affiliated with or endorsed by xAI.</p>
            </div>
        </>;
    }
}
